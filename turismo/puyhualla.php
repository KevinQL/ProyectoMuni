...
<div class="col-md-12 p-0 m-0 mb-1">
  ...
  <a href="#" data-toggle="modal" data-target=".modal-xl-one">
    <img src="../file-ignore/puyhualla/img1.jpg" alt="" class="img-fluid rounded-lg" height="" style="width: 100%">
  </a>
  <!-- Todo el modal -->
  <div class="modal fade modal-xl-one" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">        
      <div class="modal-content">
        <img src="../file-ignore/puyhualla/img1.jpg" alt="" class="img-fluid" style="width: 100%">
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row px-md-3">
    <div class="col-md-4 p-md-0">                      
      ...
      <a href="#" data-toggle="modal" data-target=".modal-xl-two">
        <img src="../file-ignore/puyhualla/img2.jpg" class="img-fluid" style="width: 100%" alt="">
      </a>
      <!-- Todo el modal -->
    ...
    <div class="col-md-4 p-md-0">
      ...
      <a href="#" data-toggle="modal" data-target=".modal-xl-three">
        <img src="../file-ignore/puyhualla/img3.jpg" class="img-fluid" style="width: 100%" alt="">
      </a>
    ...
    <div class="col-md-4 p-md-0">
      ...
      <a href="#" data-toggle="modal" data-target=".modal-xl-four">
        <img src="../file-ignore/puyhualla/img4.jpg" class="img-fluid" style="width: 100%" alt="">
      </a>
